...
#         post :create, {:favorite => { "quote_id" => "invalid value" }}, valid_session
#         assigns(:favorite).should be_a_new(Favorite)
#       end
#
...
#         Favorite.any_instance.should_receive(:update).with({ "quote_id" => "1" })
#         put :update, {:id => favorite.to_param, :favorite => { "quote_id" => "1" }}, valid_session
#       end
#
#       it "assigns the requested favorite as @favorite" do
#         favorite = Favorite.create! valid_attributes
...
#         # Trigger the behavior that occurs when invalid params are submitted
#         Favorite.any_instance.stub(:save).and_return(false)
#         put :update, {:id => favorite.to_param, :favorite => { "quote_id" => "invalid value" }}, valid_session
#         assigns(:favorite).should eq(favorite)
#       end
#
